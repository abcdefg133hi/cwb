...
plot(x=n1$Time,y=n1$weight,type='o',main="Chicken 1",las=1,lwd=2,xlab="Time",ylab="Weight",col="pink")
...
plot(x=n24$Time,y=n24$weight,type='o',main="Chicken 24",las=1,lwd=2,xlab="Time",ylab="Weight",col="orange3")
plot(x=n25$Time,y=n25$weight,type='o',main="Chicken 25",las=1,lwd=2,xlab="Time",ylab="Weight",col="orange2")
plot(x=n26$Time,y=n26$weight,type='o',main="Chicken 26", las=1,lwd=2,xlab="Time",ylab="Weight",col="orange1", xlim=c(0,21),ylim=c(0,250))
plot(x=d2$Time,y=d2$weight,type='p',main="Diet 2",las=1,xlab="Time",ylab="Weight",col="orange4")
